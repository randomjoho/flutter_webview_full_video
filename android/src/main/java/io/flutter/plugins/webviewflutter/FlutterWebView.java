...
public class FlutterWebView implements PlatformView, MethodCallHandler , EventChannel.StreamHandler {
  ...
  FlutterWebView(
    ...
    EventChannel eventChannel = new EventChannel(messenger,"Orientation");
    ...
    flutterWebChromeClient = new FlutterWebChromeClient(
            methodChannel, (ViewGroup) webView.getRootView(), new FlutterWebChromeClient.MyCallBack() {
      @Override
      public void send(boolean isFullScreen) {
        if(eventSink!=null){
          eventSink.success(isFullScreen);
        }
      }
    });
  ...
  private void canGoBack(Result result) {
    if(flutterWebChromeClient.isFullscreen){
      result.success(true);
      return;
    }
  ...
  private void goBack(Result result) {
    ...
    if(flutterWebChromeClient.exitFullscreen()){
      return;
    }
