...
class WebViewController {
  ...
  static Stream<bool> _streamLink;
  static const EventChannel _eChannelLink =
  const EventChannel("Orientation");
  Stream<bool> getOrientationStream() {
//    if (  _streamLink == null) {
//      _streamLink = _eChannelLink.receiveBroadcastStream().cast<bool>();
//    }
//    return _streamLink;
  return _streamLink = _eChannelLink.receiveBroadcastStream().cast<bool>();;
